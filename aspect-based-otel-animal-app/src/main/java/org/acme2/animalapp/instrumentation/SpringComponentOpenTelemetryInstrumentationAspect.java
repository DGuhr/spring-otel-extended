...
@Aspect
@Component
public class SpringComponentOpenTelemetryInstrumentationAspect extends AbstractSpringOpenTelemetryInterceptor {

    @Around("publicMethodOfComponent() && " +
    ...
    public Object traceAroundComponentMethods(ProceedingJoinPoint pjp) throws Throwable {
        return wrapWithSpan(pjp);
    }

    @Pointcut("within(@org.springframework.stereotype.Component *)")
    static void beanAnnotatedWithComponent() {
    }

    @Pointcut("beanAnnotatedWithComponent() && publicMethod()")
    static void publicMethodOfComponent() {
    }
